...
class Generator:
    ...
    def generate(self, ):
        ...
        response = requests.post(url='https://8911-35-186-154-248.ngrok-free.app/predict/', data=json.dumps(request))
        # print(response)
        return response
...
class Person:
    ...
    def calories_calculator(self):
        activites = ['Little no exercise', 'Light exercise', 'Moderate exercise(3-5)days wk', 'Very active(6-7)days wk',
